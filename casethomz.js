...
*⊷ SCRIPT BY : ZErvida*
*⊷ BOT NAME : ZErvida*
*⊷ PENGGUNA NAME : ${m.pushName}*
*⊷ BUY SC : gratis*
*⊷ BUY BOT : free dean*
*⊷ RUNTIME : ${runtime(process.uptime())}*

 *FITUR OWNER*
*ৡ*${prefix} capek kontol
*ৡ*${prefix} tagall
*ৡ*${prefix} join
...
*ৡ*${prefix} ceknamagc
*ৡ*${prefix} infogc
*ৡ*${prefix} pushkontakid
*ৡ*${prefix} pushkontakgc
*ৡ*${prefix} pushkontakidjd
*ৡ*${prefix} pushkontakgcjd
*ৡ*${prefix} savecontactid
*ৡ*${prefix} savecontactgc
*ৡ*${prefix} savekontak
*ৡ*${prefix} sendkontak
*ৡ*${prefix} save
...
case 'remini':
			...
			thomvelz.sendMessage(m.chat, { image: proses, caption: '🍁 Ini Hasilnya Kak...'}, { quoted: m})
			await sleep(5000)
			}
			break
...
let barang = t[0];
let nominal = t[1];
reply(`*━━ TRANSAKSI BERHASIL BY ZErvida ━━*
...
break
case "listvps": {
const text12 = `OPEN VPS? cuma aksesoris 😂
...
let groups = Object.entries(getGroups).slice(0).map((entry) => entry[1])
let anu = groups.map((v) => v.id)
let teks = `⬣ *LIST GROUP BY ZErvida*\n\n`
for (let x of anu) {
let metadata2 = await thomvelz.groupMetadata(x)
